...
export const MAP_W = 960, MAP_H = 640, T_RADIUS = 36;

export const TERRITORIES = [
  { id:0,  name:'Indus Valley',   cx:75,  cy:330, terrain:'desert',      def:0, adj:[1,2,4] },
  { id:1,  name:'Ganges',         cx:185, cy:400, terrain:'plains',      def:0, adj:[0,2] },
  { id:2,  name:'Persia',         cx:290, cy:285, terrain:'desert',      def:1, adj:[0,1,3,4,6] },
  { id:3,  name:'Mesopotamia',    cx:340, cy:230, terrain:'plains',      def:0, adj:[2,4,6,10] },
  { id:4,  name:'Arabia',         cx:275, cy:390, terrain:'desert',      def:1, adj:[0,2,3,5] },
  { id:5,  name:'Egypt',          cx:260, cy:455, terrain:'desert',      def:0, adj:[4,7,16] },
  { id:6,  name:'Anatolia',       cx:400, cy:245, terrain:'mountains',   def:2, adj:[2,3,7,8,10,15] },
  { id:7,  name:'Greece',         cx:450, cy:320, terrain:'coast',       def:1, adj:[5,6,8,15] },
  { id:8,  name:'Italia',         cx:435, cy:400, terrain:'coast',       def:0, adj:[6,7,9,10] },
  { id:9,  name:'Gaul',           cx:375, cy:180, terrain:'plains',      def:0, adj:[8,10,11,12,15] },
  { id:10, name:'Hispania',       cx:310, cy:260, terrain:'peninsula',   def:1, adj:[3,6,8,9,16] },
  { id:11, name:'Britannia',      cx:345, cy:80,  terrain:'island',      def:1, adj:[9,12,13] },
  { id:12, name:'Germania',       cx:475, cy:125, terrain:'forest',      def:2, adj:[9,11,13,14,15] },
  { id:13, name:'Scandinavia',    cx:465, cy:40,  terrain:'mountains',   def:2, adj:[11,12,14] },
  { id:14, name:'Eastern Europe', cx:545, cy:190, terrain:'plains',      def:0, adj:[12,13,15,17] },
  { id:15, name:'Balkans',        cx:470, cy:280, terrain:'mountains',   def:1, adj:[6,7,9,12,14] },
  { id:16, name:'North Africa',   cx:230, cy:510, terrain:'coast',       def:1, adj:[5,10] },
  { id:17, name:'Japan',          cx:720, cy:200, terrain:'island',      def:1, adj:[14] },
];
...
export const NEUTRALS = { 2:3, 3:3, 4:3, 7:3, 10:3, 16:3 };
...
export const WEAPONS = {
  ...
  2: [
    { name:'Musket',    atk:3, def:0, cost:30, icon:'\u{1F52B}' },
    { name:'Knight',    atk:1, def:2, cost:35, icon:'\u265E' },
    { name:'Cannon',    atk:4, def:0, cost:40, icon:'\u{1F4A3}' },
  ],
  3: [
    { name:'Rifle',     atk:5, def:0, cost:60, icon:'\u{1F52B}' },
    { name:'Artillery', atk:6, def:0, cost:70, icon:'\u{1F4A3}' },
    { name:'Cavalry',   atk:3, def:2, cost:55, icon:'\u{1F40E}' },
  ],
  4: [
    { name:'Machine Gun',atk:8, def:0, cost:100,icon:'\u{1F52B}' },
    { name:'Tank',       atk:10,def:5, cost:120,icon:'\u{1F3FB}' },
    { name:'Bomber',     atk:12,def:0, cost:150,icon:'\u2708' },
  ],
};
